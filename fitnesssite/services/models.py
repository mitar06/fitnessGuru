    ...
    def clean(self):
        ...
        if self.internal_page and self.external_page:
            ...
            raise ValidationError({
                'internal_page' : ValidationError('Please Choose internal page or external page, not both.'),  # noqa: E501
                'external_page' : ValidationError('Please Choose internal page or external page, not both.'),  # noqa: E501
